            ...
            child: Column(
              children: [
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                InkWell(
                                    ...
                                    child: Text('Service',style: TextStyle(color: Colors.grey,fontWeight: FontWeight.w500),)),
                              ],
                            ),
                          ),
                        ),
                ...
                Row(
                  ...
                  children: [
                    Text('Type product name',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 16),),
