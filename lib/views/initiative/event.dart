            ...
            child: Column(
              children: [
                          ...
                          child: Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                InkWell(
                                    onTap: (){
                                      Get.offAndToNamed('/cause');
                                    },
                                    child: Text('Cause',style: TextStyle(color: Colors.grey,fontWeight: FontWeight.w500),)),
                              ],
                            ),
                          ),
                        ),
                ...
                Row(
                  ...
                  children: [
                    Text('Type event name',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 16),),
                ...
                Column(
                    children: [
                      ArticleText(text: 'Write a event description',),
                      Padding(
