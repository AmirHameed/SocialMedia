            ...
            child: Column(
              children: [
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                InkWell(
                                    ...
                                    child: Text('Event',style: TextStyle(color: Colors.grey,fontWeight: FontWeight.w500),)),
                                Neumorphic(
                                  style: NeumorphicStyle(
                                      shape: NeumorphicShape.concave,
                                      boxShape:
                ...
                Row(
                  ...
                  children: [
                    Text('Type cause name',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 16),),
                ...
                Column(
                    children: [
                      ArticleText(text: 'Write a cause description',),
                      Padding(
