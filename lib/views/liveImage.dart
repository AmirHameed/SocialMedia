    ...
    return Scaffold(
      ...
      floatingActionButton: Center(
        child: FloatingActionButton(
          ...
          child: Icon(
            videoController.controller.value.isPlaying ? Icons.pause : Icons.play_arrow,
            color: Colors.grey,
          ),
        ),
      ),
          ...
          child: Column(children: [
                ...
                Row(
                  children: [
                    ...
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text("Elon22> Tesla.Motors", style: TextStyle(
                            fontSize: width / 20,
                    ...
                    Column(
                      children: [
                        Row(
                          children: [
                            Image.asset('assets/images/Group 1527.png',
                              height: 10,),
                            Container(
                            ...
                            Image.asset('assets/images/Group 2139.png',
                              height: 10,),
                          ],
                        ),
                        Text(('246 Vibe'), style: TextStyle(
            ...
            Padding(
              ...
              child: Row(children: [
                Expanded(
                    flex:5,
                    child: Text('Good work guys! I remember the t...', style:TextStyle(fontSize: 18,color: Colors.white,),overflow: TextOverflow.ellipsis,maxLines: 1,)),
                Expanded(
                  flex:2,
                  child: InkWell(
                      onTap: (){
                      ...
                      child: Text('see more', style:  TextStyle(fontSize: 18,color: Colors.white,fontWeight: FontWeight.w700),)),),
              ],),
            ),
          ],),
        ),
