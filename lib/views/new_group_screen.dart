      ...
      appBar: AppBar(
          ...
          Column(
            ...
            children: [
              ...
              Text('Add Subject',style: TextStyle(fontSize: 12,color: Colors.black),),
            ],
          ),
        actions: [
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text('Provide a group subject optional group icon',style: TextStyle(color: Colors.grey),),
                ),
                Align(
                ...
                Text('Participants : 12',style: TextStyle(color: Colors.grey),),
                Padding(
                        ...
                        return   Padding(
                          ...
                          child: Column(
                            children: [
                              ...
                              Text('Xavier Smith',style: TextStyle(color: Colors.grey),),
                            ],
                          ),
                        );
                      }),
                ...
                Text('Additional Settings',style: TextStyle(fontWeight: FontWeight.bold),),
                Padding(
